...
//        keyValue.put("Italy", Integer.parseInt("39"));
//        keyValue.put("Malaysia", Integer.parseInt("60"));
//        keyValue.put("Indonesia", Integer.parseInt("62"));
//        keyValue.put("Singapore", Integer.parseInt("65"));
//        keyValue.put("China", Integer.parseInt("86"));
//        keyValue.put("Russia", Integer.parseInt("7"));
